...
public class Branch{
     ...
     * This method print the Branch attributes
     * @return String
     */
    @Override
    public String toString(){
        return "BranchID:"+this.getBranchID()+" AddressCountry:"+this.getAddressCountry()+" AddressCity:"
                +this.getAddressCity()+" AddressStreetNo:"+this.getAddressStreetNo();
    }
}
